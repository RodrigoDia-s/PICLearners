...
namespace ClinicaVeterinaria
{
    public partial class Questionario : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            dt = conteudodb.fnConsultarPerguntasPorSharp(val);
        ...
        protected void grdquestions_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if(e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    DataRow[] DataSourceSelectResultProcessingOptions = dt.Select("Id_Perg_sharp = " + (Convert.ToInt32(hdnquestionId)));
                    DataView view = new DataView();
                    view.Table = dt;
                    view.RowFilter = "Id_Perg_sharp" + (Convert.ToInt32(hdnquestionId.Value));
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            ...
            conteudodb.fnIncluirPontuacaoSharp(val, id, count);
        }
