<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuestionarioC.aspx.cs" Inherits="ClinicaVeterinaria.QuestionarioC" %>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
                  <table style="width:100%">
                      ...
                      <tr>
                          <td>
                            <asp:GridView ID="grdquestions" runat="server" AutoGenerateColumns="false" OnRowDataBound="grdquestions_RowDataBound" DataKeyNames="Id_perg_c" Width="100%">
                                <Columns>
                                    <asp:TemplateField HeaderText="Questionário">
                                        <ItemTemplate>
                                            <table class="tableclass" id='<%#Eval("Id_Perg_c ") %>''>
                                                <tr>
