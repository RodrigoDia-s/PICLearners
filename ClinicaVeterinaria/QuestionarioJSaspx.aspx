<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuestionarioJSaspx.aspx.cs" Inherits="ClinicaVeterinaria.QuestionarioJSaspx" %>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
                  <table style="width:100%">
                      ...
                      <tr>
                          <td>
                            <asp:GridView ID="grdquestions" runat="server" AutoGenerateColumns="false" OnRowDataBound="grdquestions_RowDataBound" DataKeyNames="Id_perg_script" Width="100%">
                                <Columns>
                                    <asp:TemplateField HeaderText="Questionário">
                                        <ItemTemplate>
                                            <table class="tableclass" id='<%#Eval("Id_Perg_script") %>''>
                                                <tr>
