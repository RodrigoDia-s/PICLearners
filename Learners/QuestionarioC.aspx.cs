...
namespace Learners
{
    public partial class QuestionarioC : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            dt = conteudodb.fnConsultarPerguntasPorC(val);
        ...
        protected void grdquestions_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    DataRow[] DataSourceSelectResultProcessingOptions = dt.Select("Id_Perg_c = " + (Convert.ToInt32(hdnquestionId)));
                    DataView view = new DataView();
                    view.Table = dt;
                    view.RowFilter = "Id_Perg_c" + (Convert.ToInt32(hdnquestionId.Value));
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            ...
            conteudodb.fnIncluirPontuacaoC(val, id, count);
        }
