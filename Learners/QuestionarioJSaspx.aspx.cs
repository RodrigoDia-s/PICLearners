...
namespace Learners
{
    public partial class QuestionarioJSaspx : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            dt = conteudodb.fnConsultarPerguntasPorScript(val);
        ...
        protected void grdquestions_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    DataRow[] DataSourceSelectResultProcessingOptions = dt.Select("Id_Perg_script = " + (Convert.ToInt32(hdnquestionId)));
                    DataView view = new DataView();
                    view.Table = dt;
                    view.RowFilter = "Id_Perg_script" + (Convert.ToInt32(hdnquestionId.Value));
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            ...
            conteudodb.fnIncluirPontuacaoScript(val, id, count);
        }
